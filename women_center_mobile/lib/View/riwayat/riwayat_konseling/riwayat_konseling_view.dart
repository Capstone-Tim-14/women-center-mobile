...
import 'package:women_center_mobile/View/riwayat/riwayat_konseling/riwayat_konseling_dibatalkan.dart';
import 'package:women_center_mobile/View/riwayat/riwayat_konseling/riwayat_konseling_selesai.dart';
import 'package:women_center_mobile/View/riwayat/riwayat_konseling/riwayat_konseling_terjadwal.dart';

class RiwayatKonselingView extends StatelessWidget {
  @override
      ...
      children: [
        Container(
          ...
          child: DropdownButton<String>(
            ...
            items: <String>['Semua', 'Selesai', 'Dibatalkan', 'Terjadwal']
    ...
    if (dropdownValue == 'Semua') {
      return Column(
        children: [
          ...
          RiwayatKonselingSelesai(),
          RiwayatKonselingTerjadwal(),
          RiwayatKonselingBatal(),
        ],
      );
    } else if (dropdownValue == 'Selesai') {
      return RiwayatKonselingSelesai();
      // RiwayatKonselorSelesai();
    } else if (dropdownValue == 'Dibatalkan') {
      return RiwayatKonselingBatal();
      // RiwayatKonselirBatalkan();
    } else if (dropdownValue == 'Terjadwal') {
      return RiwayatKonselingTerjadwal();
      // RiwayatKonselirBatalkan();
    } else {
      return Container(
